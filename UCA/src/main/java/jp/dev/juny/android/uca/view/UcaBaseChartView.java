 ...
 */
public class UcaBaseChartView extends View implements ChartChangeListener, ChartProgressListener {

    /** The user interface thread handler. */
    private Handler mHandler;

    public UcaBaseChartView(Context context) {
        super(context);
        mHandler = new Handler();
        this.initialize();
    }

    public UcaBaseChartView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mHandler = new Handler();
        this.initialize();
    }
